...
save results /outfile= '/Users/nilskarlsson/Documents/namnlös mapp' / var=root rawdata means percntyl .

end matrix.

* plots the eigenvalues, by root, for the real/raw data and for the random data.
GET file= '/Users/nilskarlsson/Documents/namnlös mapp'.
...
COMPUTE Outliers_p_value=CDF.CHISQ(MAH_1,28).
EXECUTE.

COMPUTE p_value=($CASENUM-0.5)/147.
EXECUTE.

COMPUTE chi_sq=IDF.CHISQ(p_value,28).
EXECUTE.
...
BEGIN GPL
  ...
  GUIDE: text.title(label("Scatter Plot of chi_sq by Mahalanobis Distance"))
...
save results /outfile= 'lab_6_assignment_dataset.savscreedata.sav' / var=root rawdata means percntyl .

end matrix.

* plots the eigenvalues, by root, for the real/raw data and for the random data.
GET file= 'lab_6_assignment_dataset.savscreedata.sav'.
TSPLOT VARIABLES= rawdata means percntyl /ID= root /NOLOG.

FACTOR
  /VARIABLES ar5 ar13 ar10 ar26 ar4 ar23 ar6 ar2 ar27 ar9 ar19 ar7 ar12 ar15 ar17 ar22 ar20 ar11 
    ar25 ar14
  /MISSING LISTWISE 
  /ANALYSIS ar5 ar13 ar10 ar26 ar4 ar23 ar6 ar2 ar27 ar9 ar19 ar7 ar12 ar15 ar17 ar22 ar20 ar11 
    ar25 ar14
...
* Enter the name/location of the data file for analyses after "FILE =";
  ...
  you can use the "/ VAR =" subcommand after "/ missing=omit"
  subcommand to select variables for the analyses.
GET raw / FILE = * / missing=omit / VAR = ar2, ar4, ar5, ar6, ar7, ar9, ar10, ar11, ar12, ar13, ar14, ar15, ar17, ar19, ar20, ar22, ar23, ar25, ar26, ar27.
...
DESCRIPTIVES VARIABLES=post_extraction_communality
  /STATISTICS=MEAN.
